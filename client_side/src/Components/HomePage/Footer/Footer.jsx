    ...
    >
      ...
      <div className="max-w-7xl mx-auto flex flex-wrap justify-between gap-8 -mt-10 sm:mt-30">
        ...
        <div className="w-full sm:w-auto">
          ...
          <p className="text-gray-800">shop 10 Ground Floor Ghansoli</p>
          <p className="text-gray-800">Howrah Chowk sector 3 Ambika</p>
          <p className="text-gray-800">Darshan SocietyThane, Maharashtra,</p>
          <p className="text-gray-800">400701, India</p>
