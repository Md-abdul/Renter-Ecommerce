        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="w-full md:w-64 flex-shrink-0">
            <nav className="sticky top-8">
              <ul className="space-y-2">
                <li>
                  <a href="#information-collected" className="w-full text-left px-4 py-2 rounded-lg transition-all duration-200 cursor-pointer text-gray-700 hover:bg-gray-100 block">
                    1. Information We Collect
                  </a>
                </li>
                <li>
                  <a href="#use-information" className="w-full text-left px-4 py-2 rounded-lg transition-all duration-200 cursor-pointer text-gray-700 hover:bg-gray-100 block">
                    2. How We Use Your Information
                  </a>
                </li>
                <li>
                  <a href="#cookies" className="w-full text-left px-4 py-2 rounded-lg transition-all duration-200 cursor-pointer text-gray-700 hover:bg-gray-100 block">
                    3. Cookies
                  </a>
                </li>
                <li>
                  <a href="#data-security" className="w-full text-left px-4 py-2 rounded-lg transition-all duration-200 cursor-pointer text-gray-700 hover:bg-gray-100 block">
                    4. Data Security
                  </a>
                </li>
                <li>
                  <a href="#changes-policy" className="w-full text-left px-4 py-2 rounded-lg transition-all duration-200 cursor-pointer text-gray-700 hover:bg-gray-100 block">
          ...
          <div className="flex-1 bg-white rounded-xl shadow-sm p-6 md:p-8">
            <div className="space-y-8">
              ...
              {/* Section 2 */}
              <section id="use-information" className="scroll-mt-20">
              ...
              <section id="cookies" className="scroll-mt-20">
                ...
                <p className="mb-4">
                  We use cookies to personalize content, analyze our traffic, and improve your browsing
                  experience.
                </p>
              </section>
