...
//   // Update the handleSubmit function for PhonePe payment
  ...
  useEffect(() => {
    const fetchUserProfile = async () => {
      try {
        ...
        const isComplete = user?.name && user?.phoneNumber && user?.address;
        ...
        if (isComplete) {
          setFormData({
            ...formData,
            name: user.name || "",
            address: user.address || "", // Use the full address string
            city: "", // You might want to parse the city from the address if needed
            zipCode: "", // You might want to parse the zip code from the address
          });
