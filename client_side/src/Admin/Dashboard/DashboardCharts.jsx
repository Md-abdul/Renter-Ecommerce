...
const DashboardCharts = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const productsResponse = await axios.get("https://renter-ecommerce-2.onrender.com/api/products");
        const usersResponse = await axios.get("https://renter-ecommerce-2.onrender.com/api/user/allUser");
        
        const token = localStorage.getItem("adminToken");
        const ordersResponse = await axios.get("https://renter-ecommerce-2.onrender.com/api/orders/admin", {
          headers: {
