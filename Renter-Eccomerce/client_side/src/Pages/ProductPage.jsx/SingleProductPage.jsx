...
const SingleProductPage = () => {
  ...
  const calculateFinalPrice = () => {
    ...
    // Add color price adjustment if color is selected
    if (selectedColor) {
  ...
  const handleAddToCart = () => {
    ...
    // Call addToCart with the product and selectedQuantity
    addToCart(
      {
        ...product,
        ...
        originalPrice: finalPrice, // Include original price
  ...
  //           <span>+₹{selectedColor.priceAdjustment.toFixed(2)}</span>
  //         </div>
  //       )}
  //       {selectedSize && (
  //         <div className="flex justify-between">
  ...
  //           <span>
  //             +₹{product.sizes.find(s => s.size === selectedSize)?.priceAdjustment.toFixed(2) || "0.00"}
  //           </span>
  //         </div>
  //       )}
  ...
  //           <span>-₹{(finalPrice * (product.discount / 100)).toFixed(2)}</span>
  //         </div>
  //       )}
  //       <div className="border-t border-gray-200 pt-1 flex justify-between font-semibold text-lg">
  //         <span>Total:</span>
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-7xl">
      <div className="flex flex-col lg:flex-row gap-8">
        {/* Images Section */}
        <div className="lg:w-1/2" style={{ border: "1px" }}>
        ...
        <div className="lg:w-1/2">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-8">
            <button
              ...
              className={`flex-1 py-3 rounded-md flex items-center justify-center gap-2 transition-colors shadow-md hover:shadow-lg font-medium ${
