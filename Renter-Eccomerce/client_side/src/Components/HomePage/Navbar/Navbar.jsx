...
//                   className="px-4 py-2 bg-red-500 text-white rounded-md hover:bg-red-600 transition-all duration-300 cursor-pointer"
//                 >
//                   Logout
//                 </button>
//               </div>
          ...
          <div className="hidden md:flex items-center space-x-4">
            {isAuth ? (
              ...
              >
                ...
                {/* Enhanced Profile Dropdown with right-to-left animation */}
                {showProfileDropdown && (
                  <div 
